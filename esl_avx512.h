...
extern void esl_avx512_dump_512i_hex8(simde__m512i v);
...
esl_avx512_hmax_epu8(simde__m512i a)
{
  ...
  simde__m256i b = _mm256_max_epu8(_mm512_extracti32x8_epi32(a, 0), _mm512_extracti32x8_epi32(a, 1));
...
esl_avx512_hmax_epi8(simde__m512i a)
{
  simde__m256i b = _mm256_max_epi8(_mm512_extracti32x8_epi32(a, 0), _mm512_extracti32x8_epi32(a, 1));
...
esl_avx512_hmax_epi16(simde__m512i a)
{
  simde__m256i b = _mm256_max_epi16(_mm512_extracti32x8_epi32(a, 0), _mm512_extracti32x8_epi32(a, 1));
 ...
 * Synopsis: sums the floating-point values in an simde__m512 vector
 *           returns the result in ret_sum
 * Purpose:  To compute the sum of the 32-bit float elements of a 512-bit vector 
 */
static inline void
esl_avx512_hsum_ps(simde__m512 a, float *ret_sum)
{
  simde__m512 temp1_AVX_512 = _mm512_shuffle_f32x4(a, a, 0x4e);  //swap high and low halves of a
  simde__m512 temp2_AVX_512 = _mm512_add_ps(a, temp1_AVX_512); // sum corresponding floats in the high, low halves
  ...
  simde__m256 temp3_AVX = _mm512_extractf32x8_ps(temp2_AVX_512, 0); //Grab the low half of temp2_AVX_512 
  ...
  *retint_ptr = _mm256_extract_epi32((simde__m256i) temp3_AVX, 0);
}
 ...
 */
static inline simde__m512i 
esl_avx512_rightshift_int8(simde__m512i v, simde__m512i neginfmask)
{
 ...
 */
static inline simde__m512i
esl_avx512_rightshift_int16(simde__m512i v, simde__m512i neginfmask)
{
 ...
 */
static inline simde__m512 
esl_avx512_rightshiftz_float(simde__m512 v)
{
  return ((simde__m512) _mm512_alignr_epi8((simde__m512i) v, _mm512_maskz_shuffle_i32x4(0xfff0, (simde__m512i) v, (simde__m512i) v, 0x90), 12));
}
 ...
 */
static inline simde__m512 
esl_avx512_leftshiftz_float(simde__m512 v)
{
  return ((simde__m512) _mm512_alignr_epi8( _mm512_maskz_shuffle_i32x4(0x0fff, (simde__m512i) v, (simde__m512i) v, 0x39), (simde__m512i) v, 4));
}
